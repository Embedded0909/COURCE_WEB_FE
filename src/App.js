...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      <header class="flex">
        <article>
          <h1 class="title big">Welcome to <br /><em>Học Cùng ET</em> Embedded</h1>
          <p>Nội dung: Chanel dành cho các bạn đam mê lĩnh vực lập trình nhúng hay còn gọi là embedded
            <br />
            - Tiếp cận với các dòng vi điều khiển phổ biến: STM32, ESP32, ARDUINO, ESP8266,...
          </p>
          ...
          <ul className="card logo-slider blog-slider">
            <li>
              ...
              <article className="padding_1x">
                ...
                <a href="#" className="title small">STM32 THANH GHI</a>
                <div className="price-tag">
                  <span className="old-price">1.200.000₫</span>
                  <span className="new-price">360.000₫</span>
                </div>
                <p>Vi điều khiển STM32 thanh ghi. <br />- Ngoại vi <br />- Sensor,...</p>
